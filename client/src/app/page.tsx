...
export default function Home() {
    ...
    <main className="h-screen w-screen bg-background text-foreground overflow-hidden">
      <div className="grid h-full w-full grid-cols-1 lg:grid-cols-2">
        ...
        <div className="flex h-full items-center justify-center lg:justify-start lg:px-12 xl:px-16 bg-gradient-to-br from-background to-muted/30">
          ...
          >
            ...
            <span className="whitespace-nowrap">
              <small className="text-2xl sm:text-3xl md:text-4xl lg:text-4xl xl:text-6xl">is</small>
              <span className="pl-2 xl:pl-4 sm:text-3xl xl:text-7xl">awesome</span>
            </span>
          </h1>
        </div>
        ...
        <div className="grid h-full grid-rows-[1fr_1fr] gap-0 lg:gap-0">
          ...
          <div className="flex h-full items-center justify-center border-b border-border bg-muted/50 lg:border-r lg:border-b-0">
            <Button
              size="sm"
              className="text-md px-4 py-2 rounded-full shadow-2xl hover:shadow-3xl transition-all duration-300 hover:scale-105"
              asChild
            >
  ...
  {/* Pattern layer – light gray lines on black */}
  <div 
  ...
  <div className="max-w-md space-y-6 relative z-10">
    <h3 className="text-xl font-semibold text-foreground/90">
      Why <span className="text-4xl">Celsius</span> Stands Out
    </h3>
    <p className="text-md sm:text-md text-muted-foreground leading-relaxed">
      Lightning-fast performance • Stunning design • Unmatched developer experience • Built for the modern web in 2026
    </p>
  </div>
</div>
